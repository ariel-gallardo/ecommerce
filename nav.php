            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content text-center">
                    ...
                    <div class="modal-body">
                        ...
                        <?php include_once 'nav/carro.php' ?>
                    </div>
                    <!-- Boton para comprar del carro de compras -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                <textarea class="form-control my-2" rows="5" placeholder = "Escribe la consulta aquí"></textarea>
